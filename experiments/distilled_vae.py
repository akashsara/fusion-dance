...
teacher_latent_dim = 2048
teacher_max_filters = 512
teacher_num_layers = 4
teacher_image_size = 64
teacher_small_conv = True
...
teacher_model = models.ConvolutionalAE(
    max_filters=teacher_max_filters,
    num_layers=teacher_num_layers,
    input_image_dimensions=teacher_image_size,
